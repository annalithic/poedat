...
namespace ImGuiNET
{
    class Program
    {
        ...
        private static bool showDatWindow = true;
        static DatWindow datWindow;
        ...
        {
            //TEMP dat load
            datWindow = new DatWindow(@"E:\Extracted\PathOfExile\3.25.Settlers\data\monstervarieties.dat64");
        ...
        private static unsafe void SubmitUI()
        {
            ...
            if(showDatWindow) {
                ImGui.Begin("DAT", ref showDatWindow);
                datWindow.Update();
                ImGui.End();
            }
